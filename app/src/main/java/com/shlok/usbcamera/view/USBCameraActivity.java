package com.shlok.usbcamera.view;
...
import com.shlok.usbcamera.UVCCameraHelper;
import com.shlok.usbcamera.application.MyApplication;
import com.shlok.usbcamera.utils.FileUtils;
...
public class USBCameraActivity extends AppCompatActivity implements CameraDialog.CameraDialogParent, CameraViewInterface.Callback {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        LinearLayout llayoutAdvanceSetting = findViewById(R.id.llayout_advance_setting);
        LinearLayout llayoutShowMore = findViewById(R.id.llayout_show_more_setting);
       ...
       // mCameraHelper.setDefaultFrameFormat(UVCCameraHelper.FRAME_FORMAT_YUYV);
        ...
        llayoutAdvanceSetting.setVisibility(View.GONE);

        llayoutShowMore.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (llayoutAdvanceSetting.getVisibility() == View.VISIBLE) {
                    llayoutAdvanceSetting.setVisibility(View.GONE);

                } else {
                    llayoutAdvanceSetting.setVisibility(View.VISIBLE);
                }
            }
        });
    ...
    public void takeTimedPics(){
        ...
        //SimpleDateFormat filesdf = new SimpleDateFormat("yyyy-MM-dd HHmmss"); //The file name cannot have：
        String FileTime =timesdf.format(new Date()).toString();//Get system time
...
//Adjust camera parameters; saturation, brightness, contrast, sensitivity
    private void initView() {
        ...
        mSeekSensitivity.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                Log.v("@@shlok","value when sliding stops："+ String.valueOf(seekBar.getProgress()));
        ...
        mSeekSaturation.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                if(mCameraHelper != null && mCameraHelper.isCameraOpened()) {
                    ...
                    Log.v("@@shlok", "value during dragging："+String.valueOf(progress) + ", " + String.valueOf(fromUser));
            ...
            @Override
            public void onStartTrackingTouch(SeekBar seekBar) {
                Log.v("@@shlok","The value when sliding starts："+ String.valueOf(seekBar.getProgress()));
            }
